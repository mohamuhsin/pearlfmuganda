...
export default function HeroContent() {
    return (
        <section className="mt-16 mb-16 sm:mt-24 sm:mb-20 overflow-hidden">
            {/* Shared container for heading and grid */}
            <div className="w-full max-w-6xl mx-auto px-6 sm:px-8">
                ...
                >
                    ...
                    <span className="text-[0.8em] whitespace-nowrap">107.9 FM</span>
                </h1>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 w-full">
                    {cards.map(({ title, icon, link }, index) => (
                        ...
                        >
                            <div className="flex flex-col items-center justify-center bg-white rounded-xl shadow-lg p-4 hover:bg-gray-100 transition-all duration-300">
                                {/* Circular Icon with Border and Background */}
                                <div className="flex items-center justify-center w-20 h-20 rounded-full border-4 border-[#0c0076] group-hover:border-[#ff7e1c] transition-colors duration-300 bg-white">
                                ...
                                {/* Card Title */}
                                <span className="text-black font-semibold text-lg text-center whitespace-nowrap overflow-hidden text-ellipsis mt-2">
                                    {title}
                                </span>
                            </div>
                        </Link>
